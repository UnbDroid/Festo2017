...
void Robotino::construir_mapa(){
    ...
    criador.criarMapa("Modulo1Teste",mapa);
}
...
void Robotino::lightLed(unsigned int digitalPort, bool onOff)// Acende o Led na porta escolhida
{
...
void Robotino::setNumeroLinhas(int linhas){
    this->numeroLinhas = linhas;
}
    int Robotino::getNumeroLinhas(){
