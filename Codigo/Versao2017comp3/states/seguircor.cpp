...
if(etapasAprox <= 0){
    ...
    */
    ...
    // Descomentar essa parte para mostrar o que est· sendo seguido
    ...
    /* O metodo de aproximacao depende de onde o disco est·



        etapaAprox 0 - Enquanto o sensor de distancia frontal n„o estiver vendo o disco

     		o robÙ usa a camera para seguir o disco

     	etapaAprox 1 - Depois que o valor lido pelo IR for menor que o limiar de aprox,

     		o robÙ usa o IR para se aproximar mais do disco

     	etapaAprox 2 - Devido a n„o linearidade do sensor, apÛs ler 5 cm, o valor lido

     		pelo IR aumenta a medida que o objeto se aproxima, ele segue assim, atÈ o

     		objeto estar a 9 cm, o que na verdade È encostado na garra.

     	etapaAprox 3 - O disco est· completamente na garra, retorna-se entao ao estado
