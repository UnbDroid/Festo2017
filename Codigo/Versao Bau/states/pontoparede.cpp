...
//*****************************************************************************************************************
// PontoParede fica a uma distancia determinada da parede
//*****************************************************************************************************************

PontoParede  *PontoParede::instance()
{
    static PontoParede  PontoParedeStateInstance;
    return &PontoParedeStateInstance;
}

PontoParede::PontoParede() {}

PontoParede::~PontoParede() {}

void PontoParede::enter(Robotino *robotino)
{
    std::cout << "Entrando no estado IrParaParede...\n";
}

void PontoParede::execute(Robotino *robotino)
{
...
void PontoParede::exit(Robotino *robotino) {}
